...
Product.create(source: "#{img_prefix}Mlekovita_wypasione_mleko_UHT_20_1L.jpeg", product_type: "dairy", description: 'Mlekovita wypasione mleko UHT 2,0% 1L', price: 2.79, quantity_available: 30)
Product.create(source: "#{img_prefix}Mlekovita_wypasione_mleko_UHT32_1L.jpeg", product_type: "dairy", description: 'Łaciate mleko UHT 3,2% 1L', price: 2.79, quantity_available: 30)
Product.create(source: "#{img_prefix}Łaciate_mleko_UHT_051L.jpeg", product_type: "dairy", description: 'Mlekovita wypasione mleko UHT 0,5% 1L', price: 2.89, quantity_available: 30)
Product.create(source: "#{img_prefix}Łaciate_mleko_UHT_201L.jpeg", product_type: "dairy", description: 'Łaciate mleko UHT 0,5% 1L', price: 2.79, quantity_available: 30)
