...
Product.create(source: "#{img_prefix}Mlekovita_wypasione_mleko_UHT_2,0%_1L.jpeg", product_type: "dairy", description: 'Mlekovita wypasione mleko UHT 2,0% 1L', price: 2.79, quantity_available: 30)
Product.create(source: "#{img_prefix}Mlekovita_wypasione_mleko_UHT_3,2%_1L.jpeg", product_type: "dairy", description: 'Łaciate mleko UHT 3,2% 1L', price: 2.79, quantity_available: 30)
Product.create(source: "#{img_prefix}Łaciate_mleko_UHT_0,5%_1L.jpeg", product_type: "dairy", description: 'Mlekovita wypasione mleko UHT 0,5% 1L', price: 2.89, quantity_available: 30)
Product.create(source: "#{img_prefix}Łaciate_mleko_UHT_2%_1L.jpeg", product_type: "dairy", description: 'Łaciate mleko UHT 0,5% 1L', price: 2.79, quantity_available: 30)
Product.create(source: "#{img_prefix}Primo_jogurt_naturalny_200g.jpeg", product_type: "dairy", description: 'Primo jogurt naturalny 200g', price: 7.72, quantity_available: 30)
Product.create(source: "#{img_prefix}Bakoma _ogurt_naturalny_gęsty.jpeg", product_type: "dairy", description: 'Bakoma jogurt naturalny gęsty', price: 8.60, quantity_available: 30)
Product.create(source: "#{img_prefix}Activia_jogurt_naturalny_180g.jpeg", product_type: "dairy", description: 'Activia jogurt naturalny 180g', price: 8.44, quantity_available: 30)
...
Product.create(source: "#{img_prefix}Wedel_czekolada_gorzka_klasyczna_64%.jpeg", product_type: "sweets", description: 'Wedel czekolada gorzka klasyczna 64%', price: 4.99, quantity_available: 35)
Product.create(source: "#{img_prefix}Wawel_czekolada_gorzka_klasyczna_70%.jpeg", product_type: "sweets", description: 'Wawel czekolada gorzka klasyczna 70%', price: 4.50, quantity_available: 35)
Product.create(source: "#{img_prefix}Kinder_chocolate_batoniki_z_mlecznej_czkolady.jpeg", product_type: "sweets", description: 'Kinder chocolate batoniki z mlecznej czkolady', price: 3.49, quantity_available: 35)
Product.create(source: "#{img_prefix}Milka_czekolada_mleczna.jpeg", product_type: "sweets", description: 'Milka czekolada mleczna', price: 5.20, quantity_available: 15)
Product.create(source: "#{img_prefix}Góralki.jpeg", product_type: "sweets", description: 'Góralki', price: 2.30, quantity_available: 15)
Product.create(source: "#{img_prefix}Wedel_WW.jpeg", product_type: "sweets", description: 'Wedel WW', price: 2.30, quantity_available: 15)
Product.create(source: "#{img_prefix}3Bit.jpeg", product_type: "sweets", description: '3Bit', price: 2.00, quantity_available: 15)
Product.create(source: "#{img_prefix}Kinder_Bueno.jpeg", product_type: "sweets", description: 'Kinder Bueno', price: 5.50, quantity_available: 15)
